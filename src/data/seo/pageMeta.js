...
export const siteVitrinePageMeta = {
  path: '/site-vitrine',
  title: 'Création Site Vitrine Artisan, Restaurant, TPE | 300-700€, livraison 24-48h - MadaDev',
  description:
    'Site vitrine professionnel sur mesure pour artisans, restaurants et TPE à Nantes. 300 à 700€, livré en 24-48h. Visible sur Google, parfait sur mobile. Devis gratuit.',
  keywords:
...
export const tarifsPageMeta = {
  ...
  description:
    'Combien coûte un site web ? Vitrine 300-700€ (24-48h), e-commerce dès 1500€ (min. 1 semaine). Prix clairs, sans surprise. Paiement après validation. Devis gratuit.',
  keywords:
...
export const nantesPageMeta = {
  ...
  description:
    'Développeur web freelance à Nantes pour artisans, restaurants et PME. Sites vitrine 300-700€ livrés en 24-48h. Boutiques en ligne dès 1500€. Présentiel ou remote.',
  keywords:
