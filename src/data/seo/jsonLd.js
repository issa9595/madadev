...
export const jsonLdSiteVitrineService = {
  ...
  description:
    'Création de sites vitrine professionnels pour artisans, restaurants et TPE à Nantes. Fourchette 300 à 700€, livraison en 24-48h pour un projet standard.',
  offers: {
    '@type': 'AggregateOffer',
    lowPrice: '300',
    highPrice: '700',
...
export const jsonLdTarifsWebPage = {
  ...
  description:
    'Prix transparents pour la création de sites web à Nantes. Sites vitrine 300 à 700€ (livraison 24-48h). E-commerce sur mesure dès 1500€ (min. 1 semaine).',
  provider: {
    '@type': 'LocalBusiness',
    name: 'MadaDev',
    url: SITE_ORIGIN,
...
export const jsonLdNantesLocalBusiness = {
  ...
  name: 'MadaDev',
  description:
    'Développeur web freelance à Nantes : sites vitrine 300-700€ en 24-48h, e-commerce sur mesure dès 1500€ (min. 1 semaine). Disponible partout en France.',
  url: SITE_ORIGIN,
  email: BUSINESS_EMAIL,
  address: postalAddressNantes(),
  geo: BUSINESS_GEO,
