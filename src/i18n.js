    ...
    siteVitrinePage: {
      ...
      niches: {
        ...
        items: [
          {
            title: '工匠与建筑业',
            description: '水管工、电工、木工、油漆工、泥水匠——展示您的专业技能，通过网站直接获取报价请求。',
            tags: ['工匠网站', '在线报价'],
          },
          {
            title: '餐厅与咖啡馆',
            description: '在线菜单、图片展示、营业时间、联系表单——吸引顾客、填满座位所需的一切。易于更新。',
            tags: ['餐厅网站', '在线菜单'],
          },
          {
            title: '零售商与小微企业',
            description: '商店、诊所、机构——在谷歌本地搜索中脱颖而出，以专业形象将访客转化为客户。',
            tags: ['南特中小企业网站', '本地SEO'],
          },
          {
            title: '自由职业者',
            description: '医生、律师、教练、治疗师、摄影师——展示您的服务与经历，简化联系或预约流程。',
            tags: ['自由职业者网站', '联系表单'],
          },
        ],
      },
      ...
      process: {
        ...
        steps: [
          ...
          {
            title: '3. 上线与付款',
            description: '您的网站发布到您的域名上。仅在您批准网站后付款——不早于此。',
          },
        ],
      },
      vsWix: {
        ...
        p2: '定制开发的网站加载速度快3倍，在竞争对手中视觉上更突出，从第一天起就针对转化进行优化——没有网站构建工具的限制。',
        checklist: [
    ...
    siteVitrinePage: {
      ...
      niches: {
        ...
        items: [
          {
            title: '職人・建設業',
            description: '配管工、電気工、大工、塗装工、左官工——あなたの技術をアピールし、サイトから直接見積もり依頼を受け付けましょう。',
            tags: ['職人向けサイト', 'オンライン見積もり'],
          },
          {
            title: 'レストラン・カフェ',
            description: 'オンラインメニュー、フォトギャラリー、営業時間、お問い合わせフォーム——来店を促しお席を埋めるために必要なすべてが揃っています。簡単に更新可能。',
            tags: ['飲食店サイト', 'オンラインメニュー'],
          },
          {
            title: '小売業・中小企業',
            description: 'ショップ、クリニック、エージェンシー——Googleローカル検索で目立ち、プロフェッショナルな存在感で訪問者を顧客へと転換します。',
            tags: ['中小企業サイト', 'ローカルSEO'],
          },
          {
            title: '自由業・フリーランス',
            description: '医師、弁護士、コーチ、セラピスト、カメラマン——サービスや経歴を伝え、問い合わせや予約を簡単に受け付けましょう。',
      ...
      process: {
        sectionTitle: '24〜48時間で納品——その仕組みは',
        ...
        steps: [
          ...
          {
            title: '3. 公開 & お支払い',
            description: 'サイトをあなたのドメインで公開します。お支払いはサイトを承認いただいた後——それ以前はいただきません。',
          },
        ],
      },
      vsWix: {
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'はい。すべてのサイトにSEO基礎が含まれています：タイトルタグ、メタ説明、見出し構造、最適化された読み込み速度。強力なローカルSEO（例：「ナント 配管工」）には、Googleビジネスプロフィールの作成をお勧めします——必要であればサポートします。',
          },
          {
            q: '前払いは必要ですか？',
